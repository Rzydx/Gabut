...
from Ayiin import BOT_USERNAME, db_mem
from Ayiin.Core.PyTgCalls import Queues
from Ayiin.Core.PyTgCalls.Ayiin import join_stream
from Ayiin.Database import (add_active_chat, add_active_video_chat,
                            is_active_chat, music_off, music_on)
from Ayiin.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
...
async def start_stream(
    ...
    if await is_active_chat(CallbackQuery.message.chat.id):
        ...
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            caption=(
                f"🎬<b>__Mengocok:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n⏳<b>__Durasi Coli:__</b> {duration_min} \n💡<b> [More Information](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤<b>__Permintaan Si Kontol:__ </b>{CallbackQuery.from_user.mention} \n🚧<b>__Antrian Sembako:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Mengocok:__ </b>[{title[:25]}](https://www.youtube.com/watch?v={videoid}) \n💡<b> [More Information](https://t.me/{BOT_USERNAME}?start=info_{videoid})\n👤**__Permintaan Si Kontol:__** {CallbackQuery.from_user.mention}"
        final_output = await CallbackQuery.message.reply_photo(
            photo=thumb,
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
...
async def start_stream_audio(
    ...
    if await is_active_chat(message.chat.id):
        ...
        final_output = await message.reply_photo(
            ...
            caption=(
                f"🎬<b>__Audio:__ </b> [Given Audio Via Telegram]({link})\n⏳<b>__Durasi Coli:__</b> {duration_min} \n👤<b>__Permintaan Si Kontol:__ </b>{message.from_user.mention} \n🚧<b>__Antrian Bansos:__</b> <b>#{position}!</b>"
            ),
        ...
        await mystic.delete()
        cap = f"🎥<b>__Audio:__ </b>[Given Audio Via Telegram]({link})\n👤**__Permintaan Si Kontol:__** {message.from_user.mention}"
        final_output = await message.reply_photo(
            photo="Utils/Telegram.JPEG",
            reply_markup=InlineKeyboardMarkup(buttons),
            caption=cap,
